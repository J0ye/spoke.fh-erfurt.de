...
export default class BottleNode extends EditorNodeMixin(Model) {
  static nodeName = "A beer";

  static legacyComponentName = "extra-gltf-model";

  static initialElementProps = {
    initialScale: "fit",
    src: "https://sketchfab.com/3d-models/fh-erfurt-beer-dea3bd51f3174904be08af113f37b9f1"
  };
